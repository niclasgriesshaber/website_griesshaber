...
export const quotes = [
  ...
  },
  {
    ...
    author: "Sheilagh Ogilvie",
    source: "''Whatever is, is right'? Economic institutions in pre-industrial Europe', Economic History Review 60(4), 2007, p. 649 (abstract)"
  },
  {
  ...
  {
    text: "Historical evidence suggests that in countries with patent laws, the majority of innovations occur outside of the patent system.",
    author: "Petra Moser",
    source: "'Patents and Innovation: Evidence from Economic History', Journal of Economic Perspectives 27(1), 2013, p. 40"
  }
];
