        ...
        <div className="max-w-4xl mx-auto px-6 pt-8 pb-12">
          ...
          <div className="space-y-6 mb-12">
            <p className="text-gray-800 text-justify leading-relaxed">
              I am a fully funded DPhil candidate at the University of Oxford and have been awarded the Advanced Quantitative Methods Award from the Economic and Social Research Council as part of UK Research and Innovation. My supervisors are <a href="https://en.wikipedia.org/wiki/Sheilagh_Ogilvie" target="_blank" rel="noopener noreferrer" className="text-gray-800 hover:text-gray-600 transition-colors">Sheilagh Ogilvie</a>, <a href="https://en.wikipedia.org/wiki/Stephen_Broadberry" target="_blank" rel="noopener noreferrer" className="text-gray-800 hover:text-gray-600 transition-colors">Steve Broadberry</a>, and <a href="https://en.wikipedia.org/wiki/Philip_Torr" target="_blank" rel="noopener noreferrer" className="text-gray-800 hover:text-gray-600 transition-colors">Philip Torr</a>.
            </p>
            <p className="text-gray-800 text-justify leading-relaxed">
